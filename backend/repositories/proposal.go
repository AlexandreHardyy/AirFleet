...
type ProposalRepositoryInterface interface {
	GetAllProposals(limit int, offset int, filter string) ([]models.Proposal, error)
...
func (r *ProposalRepository) GetAllProposals(limit int, offset int, filter string) ([]models.Proposal, error) {
